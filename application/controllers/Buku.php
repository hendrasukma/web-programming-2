    ...
    public function index()
            {
                ...
                // Form Validation Rules (dikelompokkan untuk keterbacaan)
                ...
                $this->form_validation->set_rules('id_kategori', 'Kategori', 'required', [
                    'required' => 'Nama pengarang harus diisi', // Perbaiki pesan error ini
                ]);
                ...
                $this->form_validation->set_rules('tahun', 'Tahun Terbit', 'required|min_length[4]|max_length[4]|numeric', [ // min_length diganti jadi 4
